// Componente Server-Side para conteúdo SEO
  ...
  return (
    <div className="sr-only" aria-hidden="false">
      ...
      <p>
        ...
        e durabilidade contra intempéries. Nossa serralheria trabalha com os melhores materiais do mercado.
      </p>
      ...
      <p>
        ...
        Trabalhamos com vidros temperados e laminados de alta resistência.
      </p>
      
      <h3>Entre em Contato</h3>
      <p>
        Entre em contato pelo <a href="https://wa.me/551839045308" target="_blank" rel="noopener noreferrer">WhatsApp (18) 3904-5308</a> ou visite nosso 
      ...
      <p>
        ...
        Realizamos projetos residenciais e comerciais com acabamento premium.
      </p>
      ...
      <address>
        ...
        WhatsApp: <a href="https://wa.me/551839045308" target="_blank" rel="noopener noreferrer">(18) 3904-5308</a><br />
        Horário: Segunda a Sexta, 08:00 às 18:00
      </address>
      
      <p>
        Somos referência em esquadrias de alumínio na região de Presidente Prudente. Atendemos com qualidade e 
        pontualidade há mais de 15 anos. Nossa vidraçaria oferece vidros temperados com certificação de segurança.
        Trabalhamos com mão de obra qualificada e materiais de primeira linha.
      </p>
    </div>
  );
}
